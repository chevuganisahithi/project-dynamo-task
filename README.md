# project-dynamo-task
a challenging terminal-based AI agent evaluation task.
...
Requires the [GitHub CLI](https://cli.github.com/) (`gh`). Replace `dynamo-bfe4edd-mathematics-and-formal-reasoning`
with the repository you were assigned:

```bash
gh repo fork handshake-project-dynamo/dynamo-bfe4edd-mathematics-and-formal-reasoning --clone
cd dynamo-bfe4edd-mathematics-and-formal-reasoning
git checkout -b submission
#  ... build the task (see below) ...
git add -A && git commit -m "Task submission"
git push -u origin submission
gh pr create --repo handshake-project-dynamo/dynamo-bfe4edd-mathematics-and-formal-reasoning --fill
```
